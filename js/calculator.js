...
function isEmpty() {
  if (qtdDependentes.value == "" || qtdDependentes.value == null)
    qtdDependentes.value = 0;

  if (valorDependentes.value == "" || valorDependentes.value == null)
    valorDependentes.value = "0,00";

  if (valorInss.value == "" || valorInss.value == null)
    valorInss.value = "0,00";

  if (despesasMedicas.value == "" || despesasMedicas.value == null)
    despesasMedicas.value = "0,00";

  if (despesasInstrucao.value == "" || despesasInstrucao.value == null)
    despesasInstrucao.value = "0,00";

  if (pensaoJudicial.value == "" || pensaoJudicial.value == null)
    pensaoJudicial.value = "0,00";

  if (previdencia.value == "" || previdencia.value == null)
    previdencia.value = "0,00";

  if (aposentado.value == "" || aposentado.value == null)
    aposentado.value = "0,00";
}
